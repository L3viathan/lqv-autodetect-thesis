...
To obtain a good threshold for \textbf{Unigrams}, \textbf{Bigrams}, and \textbf{Combined}, we compare their performance on the development sets \texttt{dev-1} and \texttt{dev-2}. The results can be seen in Figure~\ref{redundancy_graph}.
