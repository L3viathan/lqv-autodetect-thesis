...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item inconsistent %ranges
    \item clause-level annotation
    \item same annotation for different violations
  \end{itemize}
  \vspace{0.5cm}
  \textbf{Methods}
  \begin{itemize}
    \item tailored to corpus
...
\begin{frame}
  ...
  \textbf{Corpus}
  \begin{itemize}
    \item annotate a corpus with our type system
  \end{itemize}
\end{frame}
