...
%TODO alle evaluation auf testset
%TODO immer auf was entwickelt, trainiert, getestet (auf slides)
...
\begin{frame}
  \frametitle{LQVCorpus \citep{friedrichlqvsumm}}
  \begin{itemize}
    \item small %coverage of some types
    \item partially inconsistent\pause %ranges
    \item corpus preprocessing with CoreNLP \citep{manning-EtAl:2014:P14-5}
    \item unit of annotation (clauses vs. sentences)\pause
    \item OTHRUNGR has different violation subtypes%TODO
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item 3 features from ACE parser output %TODO
  \end{itemize}
\end{frame}

\begin{frame}
  %TODO neue Tabelle: jeweils ohne feature, nur ungrammatical. "ablation study"
  ...
  \begin{tabular}{c|c}
  \hline\hline
  Feature & Decrease in Accuracy\\%84.5391
  \hline
...
\begin{frame}
  %TODO slide mit evaluation von für jeden tyyp beste methode
